...
import { getRecipeForEdit } from '../../apis/recipe/getRecipe';
import DeleteIcon from '@mui/icons-material/Delete';
import { editRecipe } from '../../apis/recipe/editRecipe';
...
const RecipeEdit = () => {
  ...
  const updateIngredientIds = (index, data) => {
    ...
    setIngredientIds([
      ...
      {
        ...oldObj,
        ...(data.ingredientId != null && { ingredientId: data.ingredientId }),
  ...
  const handleOnChangeQuantity = (index, event) => {
    ...
    console.log('chaneg quantity', quantity);
